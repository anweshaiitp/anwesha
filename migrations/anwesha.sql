...
CREATE TABLE `CampusAmberg` (
  `pId` int(4) NOT NULL,
  `fbID` decimal(17,0) DEFAULT NULL,
...
--
-- Table structure for table `cascore`
--
...
--
-- AUTO_INCREMENT for table `cascore`
--
ALTER TABLE `cascore`
