  ...
  <script src="//code.jquery.com/ui/1.12.0/jquery-ui.js"></script>
    ...
    background-color: black;box-shadow: 0 0 50px #000000">
		...
		<div id="intro">
			...
			<ul class="links">
				<a id='blogin' href="#login"><li>Login</li></a>
		...
		<div id="register" class="lightbox logreg">
			...
			<h2>Register</h2>
				...
				<input class="button inp" type="submit" id="submitreg" value="Register" style="width:100%">
			</div>
		</div>
		...
		<div id="login" class="lightbox logreg">
			...
			<div class="box">
				...
				<input class="inp" name="password" type="password" placeholder="Password" >
