	...
	$(document).ready(function(){
		...
		var refreshIntervalId = setInterval(function(){
			FB.getLoginStatus(function(Lstatus) {
				...
				FB.api('/me?fields=name,first_name,public_profile,user_location,user_birthday,user_about_me,birthday,email,picture.width(500).height(500)', function(response) {
					console.log(response);
