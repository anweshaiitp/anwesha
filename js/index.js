    ...
    $.post("/user/register/User/",
      ...
      function (data, status) {
        ...
        if (status == 'success') {//$("#myloader").fadeOut();
          ...
          $("#loadgif").fadeOut();
          if (data[0] == 1) {
            $("#postajaxmsg").html('<center><div class="posttext"><h3><b>Registration Successful</b><br>Your Anwesha ID is : ANW' + data[1]['pId'] + '<br>A confirmation email has been sent to ' + email + '.</h3></div></center>');
            // $("#regloader").fadeOut();
            $("#postajaxmsg").fadeIn();
            $("#verify").fadeIn();
