        ...
        selector.each(function (index) {
                                ...
                                if ($(result.data).get(a).count == null && settings.skipEmptyAlbums) {
                                    ...
                                    $(albumListItem).click(function () {
                                        ...
                                        previewContainer.append($("<img>", {
                                            ...
                                            height: 32,
                                            width: 32,
                                            src: settings.pluginImagesPath + "../images/back.png",
                    ...
                    success: function (result) {
                        if (result.data.length > 0) {
                            ...
                            for (a = 0; a < result.data.length; a++) {
                                ...
                                var photoThumb = $("<img>", { style: "margin: 0.1em;display:none;", "data-id": $(result.data).get(a).id, class: "fb-photo-thumb", "data-src": albumImg.source, src: "" });
            ...
            function initLightboxes(photoLink) {
                ...
                if (overlay.length == 0) {
                    ...
                    overlay.append($("<img>", { class: "fb-preview-img-prev", src: settings.pluginImagesPath + "../images/prev-icon.png" }));
                    overlay.append($("<img>", { class: "fb-preview-img-next", src: settings.pluginImagesPath + "../images/next-icon.png" }));
